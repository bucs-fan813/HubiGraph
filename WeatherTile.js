...
function getWeather() {
    const url = `https://api.openweathermap.org/data/3.0/onecall?lat=`+latitude+`&lon=`+longitude+`&exclude=minutely,alerts&appid=`+tile_key+`&units=imperial`;
    ...
    const url2 = `https://api.openweathermap.org/data/3.0/onecall?lat=`+latitude+`&lon=`+longitude+`&exclude=minutely,alerts&appid=`+tile_key+`&units=imperial`;
